...
const Tables: React.FC = () => {
  ...
  const filteredTables = tablesData.filter(table => {
    ...
    const matchesSource = filterSource === 'all' || (table.sourceId && table.sourceId.toString() === filterSource);
  ...
  const handleMetadataUpdate = (tableId: string, updates: Partial<Table>) => {
      ...
      <div className="space-y-6">
        ...
        {selectedTableForEdit && (
          <TableMetadataEditor
            ...
            onSave={(updates) => handleMetadataUpdate(selectedTableForEdit._id.toString(), updates)}
          />
        )}
